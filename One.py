...
class Outlier():
    ...
    def __init__(self,low = 0,high = 25,t_d = 2,t_p = .40):
        ...
        points1 = np.random.uniform(0, 25, size=(100,3))
...
def main():
    ...
    user_input = input("click enter for next please look at graphs for nearest")
    ...
    user_input = input("click enter for next please look at graphs for farthest")
    ...
    user_input = input("click enter for next please look at graphs for avg")
    ...
    user_input = input("click enter for next please look at graphs for center")
